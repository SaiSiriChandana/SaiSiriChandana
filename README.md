...
I build things that start as scribbles, survive several rounds of overthinking, and eventually become working systems. My interests orbit around machine learning, backend engineering, and the kind of projects where logic and curiosity shake hands.

I learn quickly, document obsessively, and enjoy following strange tech threads just to see where they lead. When I’m not debugging, I’m usually refining ideas, exploring new tools, or adding another oddly curated playlist to the pile.

Still growing. Still experimenting. Still chasing that clean, satisfying solution. 🚀
...
- **Inquira-AI** <details><summary>View Details</summary>
  **Repo:** [https://github.com/SaiSiriChandana/Inquira-AI](https://github.com/SaiSiriChandana/Inquira-AI.git)   
  AI research assistant using FastAPI, React, FAISS, and LLMs to answer questions from uploaded PDFs.
  </details>

- **Cryptographic Key Sharing via Hand Gesture Recognition** <details><summary>View Details</summary>
  **Repo:** [https://github.com/SaiSiriChandana/Cryptographic-Key-Sharing-via-Hand-Gesture-Recognition-Using-Computer-Vision](https://github.com/SaiSiriChandana/Cryptographic-Key-Sharing-via-Hand-Gesture-Recognition-Using-Computer-Vision.git)   
  Computer vision–based method for generating and sharing cryptographic keys through hand gestures.
  </details>

- **Fire TV Context-Aware Recommender** <details><summary>View Details</summary>
